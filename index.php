            ...
            <div class="main">
                <div class="container">
                    ...
                    <ul class="portfolio-filter text-right">
                        ...
                        <li><a href="#" data-filter=".Topwear">Topwear</a></li>
                        <li><a href="#" data-filter=".Bottomwear">Bottomwear</a></li>
                        <li><a href="#" data-filter=".Innerwear">Innerwear</a></li>
                        <li><a href="#" data-filter=".Dress">Dress</a></li>
                        <li><a href="#" data-filter=".Saree">Saree</a></li>
                    </ul>
